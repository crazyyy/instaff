...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('jquery.lazy', '//cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.min.js"', array(), '1.7.9');
    wp_enqueue_script('jquery.lazy');

    wp_register_script('jquery.lazy.plugins', '//cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.plugins.min.js', array(), '1.7.9');
...
function disable_emojicons_tinymce( $plugins ) {
  ...
  function post_type_vacancies() {
    ...
    $args = array(
      'description' => 'Vacancies Post Type',
      'show_ui' => true,
      'menu_position' => 3,
