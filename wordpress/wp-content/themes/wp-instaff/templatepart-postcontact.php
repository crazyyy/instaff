<div class="block-postcontact">
  <div class="container">
    <div class="row">
      <div class="block-postcontact--left col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <h6>Контакты</h6>
      ...
      <!-- /.block-postcontact--left col-xl-6 -->
      <div class="block-postcontact--right col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <h6>Оформить заявку</h6>
        <form action="">
          <span class="block-postcontact--right__phone">
            <input type="text" placeholder="Номер телефона">
          </span>
          <span class="block-postcontact--right__email">
      ...
      <!-- /.block-postcontact--right col-xl-6 -->
    </div>
    <!-- /.row -->
  </div>
  <!-- /.container -->
